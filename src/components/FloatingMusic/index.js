...
import MusicBacksound2 from '@assets/music/beautiful-in-white.mp3';

import { styMusicFloating } from './styles';

let Musik = [MusicBacksound, MusicBacksound2];
let MusikPlay = Musik[Math.floor(Math.random() * Musik.length)];
